      ...
      <div className="bg-white rounded-3xl shadow-sm border border-outline-variant/20 overflow-hidden">
        {settlements.length > 0 ? (
          <div className="divide-y divide-outline-variant/10">
            {settlements.map((s, i) => (
              <div key={i} className="px-8 py-5 flex items-center justify-between hover:bg-surface/50 transition-colors">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <p className="font-bold text-sm text-on-surface">{s.type}</p>
